...
import com.android.picture_library.luck.picture.lib.adapter.*;
import com.android.picture_library.luck.picture.lib.animators.*;
import com.android.picture_library.luck.picture.lib.config.*;
import com.android.picture_library.luck.picture.lib.decoration.*;
import com.android.picture_library.luck.picture.lib.dialog.*;
import com.android.picture_library.luck.picture.lib.entity.*;
import com.android.picture_library.luck.picture.lib.listener.*;
import com.android.picture_library.luck.picture.lib.manager.*;
import com.android.picture_library.luck.picture.lib.model.*;
import com.android.picture_library.luck.picture.lib.observable.ImagesObservable;
import com.android.picture_library.luck.picture.lib.permissions.*;
import com.android.picture_library.luck.picture.lib.style.PictureWindowAnimationStyle;
import com.android.picture_library.luck.picture.lib.thread.PictureThreadUtils;
import com.android.picture_library.luck.picture.lib.tools.*;
import com.android.picture_library.luck.picture.lib.widget.*;
import com.android.picture_library.yalantis.ucrop.*;
        ...
        if (config.isWithVideoImage) {
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (config.minSelectNum > 0) {
                    if (imageSize < config.minSelectNum) {
                        showPromptDialog(getString(R.string.picture_min_img_num, String.valueOf(config.minSelectNum)));
                        return;
                    }
                }
                if (config.minVideoSelectNum > 0) {
                    if (videoSize < config.minVideoSelectNum) {
                        showPromptDialog(getString(R.string.picture_min_video_num, String.valueOf(config.minVideoSelectNum)));
                        return;
                    }
                }
            }
            ...
            if (config.selectionMode == PictureConfig.MULTIPLE) {
                if (PictureMimeType.isHasImage(mimeType) && config.minSelectNum > 0 && size < config.minSelectNum) {
                    String str = getString(R.string.picture_min_img_num, String.valueOf(config.minSelectNum));
                    showPromptDialog(str);
                    return;
                }
                if (PictureMimeType.isHasVideo(mimeType) && config.minVideoSelectNum > 0 && size < config.minVideoSelectNum) {
                    String str = getString(R.string.picture_min_video_num, String.valueOf(config.minVideoSelectNum));
                    showPromptDialog(str);
                    return;
                }
            }
            ...
            if (PictureMimeType.isHasVideo(media.getMimeType())) {
                if (config.maxVideoSelectNum <= 0) {
                    ...
                    if (videoSize >= config.maxVideoSelectNum) {
                        showPromptDialog(getString(R.string.picture_message_max_num, String.valueOf(config.maxVideoSelectNum)));
                    } else {
